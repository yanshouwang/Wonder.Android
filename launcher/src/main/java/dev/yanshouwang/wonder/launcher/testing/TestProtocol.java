...
package dev.yanshouwang.wonder.launcher.testing;
...
public final class TestProtocol {
    ...
    public static final String REQUEST_HOME_TO_OVERVIEW_SWIPE_HEIGHT =
            "layout_main-to-overview-swipe-height";
    ...
    public static final String REQUEST_HOME_TO_ALL_APPS_SWIPE_HEIGHT =
            "layout_main-to-all-apps-swipe-height";
    public static final String REQUEST_ICON_HEIGHT =
            "icon-height";
    public static final String REQUEST_HOTSEAT_TOP = "hotseat-top";
    public static final String REQUEST_IS_LAUNCHER_INITIALIZED = "is-launcher-initialized";
    public static final String REQUEST_FREEZE_APP_LIST = "freeze-layout_app-list";
    public static final String REQUEST_UNFREEZE_APP_LIST = "unfreeze-layout_app-list";
    public static final String REQUEST_APP_LIST_FREEZE_FLAGS = "layout_app-list-freeze-flags";
