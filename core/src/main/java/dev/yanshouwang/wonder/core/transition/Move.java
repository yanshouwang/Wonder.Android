package dev.yanshouwang.wonder.core.transition;
...
public class Move extends Transition {
    private static final String PROPERTY_X = "dev.yanshouwang.wonder.core.transition:Move:x";
    private static final String PROPERTY_Y = "dev.yanshouwang.wonder.core.transition:Move:y";
    private static final String PROPERTY_Z = "dev.yanshouwang.wonder.core.transition:Move:z";
