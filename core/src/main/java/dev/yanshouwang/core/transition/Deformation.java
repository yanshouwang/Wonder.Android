package dev.yanshouwang.core.transition;
...
public class Deformation extends Transition {
    private static final String PROPERTY_INTERPOLATION = "dev.yanshouwang.wonder.transition:Deformation:interpolation";
    ...
    public Animator createAnimator(@NonNull ViewGroup sceneRoot, @Nullable TransitionValues startValues, @Nullable TransitionValues endValues) {
        ...
        if (!startObjects.containsKey(PROPERTY_INTERPOLATION) ||
                !endObjects.containsKey(PROPERTY_INTERPOLATION)) {
            return null;
        }
