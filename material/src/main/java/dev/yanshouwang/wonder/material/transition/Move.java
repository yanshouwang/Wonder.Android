...
public class Move extends Transition {
    private static final String PROPERTY_X = "dev.yanshouwang.wonder.material.transition:Move:x";
    private static final String PROPERTY_Y = "dev.yanshouwang.wonder.material.transition:Move:y";
    private static final String PROPERTY_Z = "dev.yanshouwang.wonder.material.transition:Move:z";
